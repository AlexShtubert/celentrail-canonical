...
- Если параметра нет в `data/AI_CONTEXT.json` — НЕ спрашивай пользователя.- Не использовать “память”, прошлые чаты и догадки — только данные репозитория.- Не искать информацию вне репозитория, если задача про Celentrail.
